...
function Inner() {
  ...
  return (
    <div>
      ...
      <FilterBar search={<SearchInput value={q} onChange={setQ} placeholder="Tìm mã phiếu, nội dung, người nộp..." className="max-w-xs" />}>
      ...
      <Table
        head={["Mã phiếu", "Ngày", "Nội dung", "Nguồn thu", "Người nộp", "Số tiền", "Người tạo", ""]}
        foot={
          rows.length > 0 ? (
            <tr>
              ...
              <FootTd />
              <FootTd />
              <FootTd className="whitespace-nowrap text-[var(--success)]">+{formatVND(total)}</FootTd>
              <FootTd />
              <FootTd />
            </tr>
          ) : undefined
