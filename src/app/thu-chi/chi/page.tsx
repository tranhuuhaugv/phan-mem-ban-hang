...
function Inner() {
  ...
  const [f, setF] = useState({ date: todayISO(), amount: "", category: "Nhập hàng", partner: "", content: "", method: "tien_mat" });
  ...
  const openCreate = () => {
    setEditId(null);
    setF({ date: todayISO(), amount: "", category: "Nhập hàng", partner: "", content: "", method: "tien_mat" });
    setOpen(true);
  };
      ...
      >
        <div className="space-y-3">
          <div className="grid grid-cols-2 gap-3">
            ...
            <Field label="Số tiền (₫) *">
              <MoneyInput value={f.amount} onChange={(v) => setF((s) => ({ ...s, amount: v }))} placeholder="VD: 12.000.000" autoFocus />
            </Field>
